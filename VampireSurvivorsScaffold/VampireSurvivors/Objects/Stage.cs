...
{
	[BurstCompile]
	public class Stage : GameMonoBehaviour // TypeDefIndex: 15108
	{
		// Fields
		[SerializeField]
		private TilingBackground _TilingBackgroundPrefab; // 0x28
		[SerializeField]
		private TilingTileset _TilingTilesetPrefab; // 0x30
		[SerializeField]
		private Transform _LevelTransform; // 0x38
		...
		public EnemyController FindClosestEnemy(Vector3 queryPos, bool excludeDead = false /* Metadata: 0x01977347 */, float maxRange = 3.4028235E+38f /* Metadata: 0x01977348 */) => default; // 0x0000000186A1C180-0x0000000186A1C630
